...
void EditorLayer::OnAttach() {
...

    {
        ...
        newNode->SetTransformParams({ { -1.0, 0.0, 0.0 }, FQuaternion::Identity(), FVector3::One });
...
#pragma region Main Menu Bar
    ...
    if (ImGui::BeginMenuBar()) {
        ...
        if (ImGui::BeginMenu("Debug")) {
            ...
            if (ImGui::MenuItem("PBR", nullptr, currentDebugMode == 0)) item_selected_idx = 0;
            if (ImGui::MenuItem("Position", nullptr, currentDebugMode == 1)) item_selected_idx = 1;
            if (ImGui::MenuItem("Normal", nullptr, currentDebugMode == 2)) item_selected_idx = 2;
            if (ImGui::MenuItem("BaseColor", nullptr, currentDebugMode == 3)) item_selected_idx = 3;
            if (ImGui::MenuItem("Roughness", nullptr, currentDebugMode == 4)) item_selected_idx = 4;
            if (ImGui::MenuItem("Metallic", nullptr, currentDebugMode == 5)) item_selected_idx = 5;
            if (ImGui::MenuItem("AO", nullptr, currentDebugMode == 6)) item_selected_idx = 6;
            if (ImGui::MenuItem("Emissive", nullptr, currentDebugMode == 7)) item_selected_idx = 7;
            if (ImGui::MenuItem("Depth", nullptr, currentDebugMode == 8)) item_selected_idx = 8;
            if (ImGui::MenuItem("Skybox", nullptr, currentDebugMode == 9)) item_selected_idx = 9;
            if (ImGui::MenuItem("SkyboxPreview", nullptr, currentDebugMode == 10))
                item_selected_idx = 10;
            if (ImGui::MenuItem("IrradiancePreview", nullptr, currentDebugMode == 11))
                item_selected_idx = 11;
            if (ImGui::MenuItem("PrefilteredPreview", nullptr, currentDebugMode == 12))
                item_selected_idx = 12;
