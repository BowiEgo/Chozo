...
//=========================================================================================
// Button Image
inline void DrawButtonImage(Texture image, ImU32 tint, ImVec2 rectMin, ImVec2 rectMax, ImVec2 uv0,
                            ImVec2 uv1) {
    auto* drawList = ImGui::GetWindowDrawList();
    drawList->AddImage(GET_IM_TEXTURE_ID(image), rectMin, rectMax, uv0, uv1, tint);
};

inline void DrawButtonImage(Texture image, ImU32 tint, ImRect rectangle, ImVec2 uv0, ImVec2 uv1) {
    DrawButtonImage(image, tint, rectangle.Min, rectangle.Max, uv0, uv1);
};

inline void DrawButtonImage(Texture imageNormal, Texture imageHovered, Texture imagePressed,
                            ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed, ImVec2 rectMin,
...
inline void DrawButtonImage(Texture image, ImU32 tintNormal, ImU32 tintHovered, ImU32 tintPressed,
                            ImVec2 rectMin, ImVec2 rectMax, ImVec2 uv0 = { 0, 0 },
                            ImVec2 uv1 = { 1, 1 }) {
...
inline void DrawButtonImageByRatio(Texture image, Vector2 size) {
...
Texture LoadSVGIcon(const std::string& name, int targetSize = 32, uint32 strokeColor = COLOR_WHITE);
