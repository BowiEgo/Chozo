...
struct FImageSpecification {
    ...
    FImageViewSpecification ToImageViewSpec() const {
        FImageViewSpecification viewSpec;
        viewSpec.ViewType   = (Layers == 6) ? EImageViewType::ViewCube : EImageViewType::View2D;
        viewSpec.Format     = ChozoUtils::RHI::ToShaderDataFormat(Format);
